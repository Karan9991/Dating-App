...
import com.naeemdev.tinder.Application;
import com.naeemdev.tinder.CustomAdatpter.MainAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(R.drawable.tab_profile_on).into(tabIcon0);
        ...
        Picasso.get().load(R.drawable.tab_users_on).into(tabIcon1);
        ...
        Picasso.get().load(R.drawable.tab_swipe_on).into(tabIcon2);
        ...
        Picasso.get().load(R.drawable.tab_chat_on).into(tabIcon3);
        ...
        Picasso.get().load(R.drawable.tab_extra_on).into(tabIcon4);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0) {
                    Picasso.get().load(R.drawable.tab_profile_on).placeholder(R.drawable.tab_profile_on).into(tabIcon0);
                }
                if (tab.getPosition() == 1) {
                    Picasso.get().load(R.drawable.tab_users_on).placeholder(R.drawable.tab_users_on).into(tabIcon1);
                }
                if (tab.getPosition() == 2) {
                    Picasso.get().load(R.drawable.tab_swipe_on).placeholder(R.drawable.tab_swipe_on).into(tabIcon2);
                }
                if (tab.getPosition() == 3) {
                    Picasso.get().load(R.drawable.tab_chat_on).placeholder(R.drawable.tab_chat_on).into(tabIcon3);
                }
                if (tab.getPosition() == 4) {
                    Picasso.get().load(R.drawable.tab_extra_on).placeholder(R.drawable.tab_extra_on).into(tabIcon4);
                }
